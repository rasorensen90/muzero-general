...
class MuZeroConfig:
    def __init__(self):
        ...
        self.action_space = list(range(128))  # Fixed list of all possible actions. You should only edit the length
