...
class MuZeroConfig:
    def __init__(self):
        ...
        self.max_moves = 150000  # Maximum number of moves if game is not finished before
        ...
        ### Replay Buffer
        self.replay_buffer_size = 5  # Number of self-play games to keep in the replay buffer
